...
namespace _Scripts
{
    ...
    public class JumpAbility : MonoBehaviour
    {
        ...
        [SerializeField] private float lowJumpMultiplier = 3.3f;
        ...
        private static readonly int IsInHangTime = Animator.StringToHash("isInHangTime");
        ...
        private void Update()
        {
            ...
            _anim.SetBool(IsInHangTime, _isInHangTime);
        ...
        {
            // Hang Time
            if (_eligibleForHangTime && !_playerMovement.isGrounded && !_isInHangTime && Mathf.Abs(_rb.velocity.y) < hangTimeVelocityThreshold && _hangTimeCounter <= 0f)
            {
                _isInHangTime = true;
        ...
        private void Jump()
        {
            // SoundManager.instance.PlaySfx(_currJump == 0 ? "Jump" : "DoubleJump");
